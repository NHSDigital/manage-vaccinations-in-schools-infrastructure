...
1. Copy the s3_uri variable that is generated as output from running terraform apply
1. Start a CodeDeploy deployment referencing the s3_uri as appspec.yaml file
